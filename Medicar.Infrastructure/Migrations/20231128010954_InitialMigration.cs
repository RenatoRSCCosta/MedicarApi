        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Crm = table.Column<string>(type: "varchar", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SlotId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Hour = table.Column<double>(type: "double precision", precision: 1, nullable: false),
                    Available = table.Column<bool>(type: "boolean", nullable: false),
                    ScheduleId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Consultations_Slots_SlotId",
                        column: x => x.SlotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultations_SlotId_ScheduleId",
                table: "Consultations",
                columns: new[] { "SlotId", "ScheduleId" },
                unique: true);
